...
def node_extract(state: DocState) -> DocState:
    ...
    if state["pdf_path"].endswith(".txt"):
...
#this is the final one but i am gonnq chnage it above to run quac datset currently it onyk extrcats pdf not text if i give .txt file it wont so i am gonna make onyl one chaange in node_extrcat fucntion add change to handle both 
#  import time
# import re
# # import spacy
# # _nlp = spacy.load("en_core_web_lg")
